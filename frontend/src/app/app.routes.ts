...
import {GameListComponent} from "./main/games/components/game-list/game-list.component";
import {GameInfoComponent} from "./main/games/components/game-info/game-info.component";
